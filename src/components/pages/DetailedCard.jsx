    ...
    <div className="min-h-screen mt-10">
      ...
      <div className="relative w-full h-[600px]">
        ...
        <div className="absolute bottom-10 left-10 text-white space-y-3">
          ...
          <span className="bg-yellow-500 px-4 py-1 rounded-full text-sm uppercase tracking-wide">
            {property.for}
          </span>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-10 space-y-12">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-gray-800">
          <div className="bg-white/80 shadow-sm p-5 rounded-xl text-center">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-3">
            {property.amenities.map((amenity, i) => (
              <span
                key={i}
                className="bg-yellow-50 text-yellow-800 px-5 py-2 rounded-full text-sm font-medium"
              >
                {amenity}
              </span>
            ))}
        ...
        {/* Contact CTA */}
        <div className="flex justify-between items-center pt-10 border-t border-yellow-300/50">
          <Button
            variant="outline"
            onClick={() => navigate(-1)}
          ...
          <Button className="bg-yellow-600 hover:bg-yellow-700 text-white text-lg px-8 py-6 rounded-xl">
            Contact Agent
          </Button>
        </div>
      </div>
